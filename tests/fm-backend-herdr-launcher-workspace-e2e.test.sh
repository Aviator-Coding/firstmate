...
# operation goes through bin/fm-herdr-lab.sh, which scopes the call to the named
# session and verifies the default fleet session is unchanged after teardown.
set -u
