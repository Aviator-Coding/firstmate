...
# (0.2.x) or "Esc:cancel" (1.0.x, live-verified against grok 1.0.4
# (d846eb93d94d) [stable] - see fm-busy-lib.sh's fm_busy_grok_tail_busy header);
# agy: "esc to cancel".
...
FM_DELIVERY_BUSY_REGEX_DEFAULT='esc (to )?interrupt|Working(\.\.\.|…)|Ctrl\+c:cancel|Esc:cancel|ctrl\+c to stop|esc[[:space:]]+to[[:space:]]+cancel'
...
FM_DELIVERY_GROK_BUSY_REGEX_DEFAULT='Ctrl\+c:cancel|Esc:cancel'
